...
rm(list=ls())
setwd('D:/desk/XMSH_202306_4587/5.Random_forest')
# author wenbo.kou, jiang.liu
...
train.rf <- randomForest(
  as.data.frame(train.x[, marker.p]), train.y,
...
bplot <- ggboxplot(plot_dta,
                   ...
                   palette = c("#00468BFF", "#ED0000FF","#42B540FF", "#0099B4FF","#925E9FFF", "#FDAF91FF")
) +
